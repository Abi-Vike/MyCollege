...
<title>RVU-GADA : Admission Portal</title>
...
<div class="probootstrap-search" id="probootstrap-search">
    ...
    <div class="probootstrap-page-wrapper">
        ...
        <div class="container">
          ...
          <div id="navbar-collapse" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              <li class="active"><a href="enlight.php">Home</a></li>
              ...
              <li><a href="user/login.php"><button class="btn btn-primary">Login</button></a></li>
      ...
      <section class="probootstrap-section" id="programs">
        <div class="container">
          <div class="row">
    ...
    <!--footer------------->
    <footer>
        <p>Copyright (C) - 2023 | Developed By RVU Dev-Team </a> </p>
    </footer>
</body>
