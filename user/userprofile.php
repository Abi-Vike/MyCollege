...
if (strlen($_SESSION['uid']==0)) {
  header('location:logout.php');
    ...
    <html class="loading" lang="en" data-textdirection="ltr">
      <head>
        <title>RVU-GADA Admission Management System || User Profile</title>
                              ...
                              <div class="row">
                                <div class="col-xl-6 col-lg-12">
                                  <fieldset>
                                    ...
                                    <div class="form-group">
                                      <input class="form-control white_bg" id="contactno" name="contactno" value="<?php  echo $row['MobileNumber'];?>" type="text" required>
                                    </div>
                                  </fieldset>
                                </div>
