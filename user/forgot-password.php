...
<head>
  <title>RVU-GADA : Student || Forgot Password</title>
              ...
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-header border-0 pb-0">
                  <div class="card-title text-center">
                    <h4 style="font-weight: bold"> Recover Forgotten Password</h4>
                  </div>
                  <hr>
                </div>
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="" method="post">
                      ...
                      <div class="row">
                        <div class="col-12 col-sm-12 col-md-12">
                          <fieldset class="form-group position-relative has-icon-left">
                            <input type="text" name="mobilenumber" id="mobilenumber" class="form-control input-lg" placeholder="Contact Number" required="true" maxlength="10" tabindex="3" required data-validation-required-message="Please enter display name.">
                            <div class="form-control-position">
                              <i class="ft-user"></i>
                            </div>
                            <div class="help-block font-small-3"></div>
