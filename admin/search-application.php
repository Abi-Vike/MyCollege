...
if (strlen($_SESSION['aid'] == 0)) {    // was ==0
  ...
  <head>
    <title>RVU Gada: Admin || Application Search</title>
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-xl-6 col-lg-12">
                            <fieldset>
                              <h5>Use Student ID, First Name, Application ID or Course Name to search </h5><br>
          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12">
              <table class="table mb-0">
                ...
                $ret = mysqli_query($con, "SELECT tbladmapplications.ID AS apid, tbladmapplications.FirstName, tbladmapplications.MiddleName, tbladmapplications.CourseApplied, tbladmapplications.PhoneNumber, tbluser.Email FROM tbladmapplications INNER JOIN tbluser ON tbluser.ID=tbladmapplications.UserId WHERE tbladmapplications.FirstName Like '%$sdata%' || tbladmapplications.ID LIKE '%$sdata%' || tbladmapplications.UserId Like '%$sdata%' || tbladmapplications.CourseApplied Like '%$sdata%'");
                $cnt = 1;
                ...
                ?>
                  ...
                  <tr align="center">
                    <td colspan="7" style="color:red; font-size: 16px;">No Records found against this search</td>
                  </tr>
                <?php } ?>
              </table>
            </div>
